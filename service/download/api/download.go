...
import (
	...
	// dlcfg "CloudStorage/service/download/config"
)
...
func DownloadURLHandler(c *gin.Context) {
	...
	if strings.HasPrefix(tblFile.FileAddr.String, cfg.TempLocalRootDir) ||
		strings.HasPrefix(tblFile.FileAddr.String, cfg.TempCephRootDir) {
	...
	} else if strings.HasPrefix(tblFile.FileAddr.String, cfg.TempOssRootDir) {
		// oss下载url
...
func DownloadHandler(c *gin.Context) {
	...
	} else if strings.HasPrefix(uniqFile.FileAddr.String, cfg.TempCephRootDir) {
